      ...
      <Container size='sm' className='flex flex-col space-y-5'>
        <div className='flex flex-col space-y-8 items-center text-center text-lg'>
          ...
          <span>
            ...
            the street is, these Broxies come with some interesting add-ons.
            I’ll let you know what I heard, but try to keep it a secret… okay?
          </span>

          <span>
            The goal of Broxie is to gather a community of homies and give them
            benefits in this world. What benefits exactly? You'll find out soon,
            we have big plans.
          </span>
        </div>
      </Container>
